...
<style>
    body {
        background-color: #DEEFF5; /* zre9 clair */
        margin: 0;
        padding: 0;
...
<body class="min-h-screen flex flex-col items-center justify-center">
    ...
    <div id="navbar" class="flex items-center justify-between w-full p-4">
    ...
    <form>
        <div class="flex">
            ...
            <div class="relative w-full">
                <input type="search" id="search-dropdown" class="block p-2.5 w-73 z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Search Mockups, Logos, Design Templates..." required>
